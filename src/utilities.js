...
const drawPath = (ctx, points, closePath) => {
  ...
  export const measureDistance = (keypoints, pointAIndex, pointBIndex) => {
    const pointA = keypoints[pointAIndex];
    const pointB = keypoints[pointBIndex];
    const distance = Math.sqrt(Math.pow(pointB[0] - pointA[0], 2) + Math.pow(pointB[1] - pointA[1], 2));
    console.log(`Distância entre os pontos: ${distance}`);
  };
